...
- commodity-news-linking: Deterministic workflow for linking raw news to canonical commodity, instrument, and ticker entities with multi-label tags and confidence. Use when implementing or changing news classification and entity mapping. (file: D:/New Project/.cursor/skills/commodity-news-linking/SKILL.md)
- news-impact-backtest-lab: Evaluation workflow for news-impact models with leakage-safe labels, horizon metrics, calibration, and promotion gates. Use when running or changing news-impact backtests. (file: D:/New Project/.cursor/skills/news-impact-backtest-lab/SKILL.md)
- signals-news-bridge-v2: Deterministic bridge between news impact events and runtime signal lifecycle/decision refs in API v2. Use when changing signal/news endpoints or news/risk gating behavior. (file: D:/New Project/.cursor/skills/signals-news-bridge-v2/SKILL.md)
...
- News/signal flow: use `commodity-news-linking`, then `news-impact-backtest-lab`, then `signals-news-bridge-v2`.
