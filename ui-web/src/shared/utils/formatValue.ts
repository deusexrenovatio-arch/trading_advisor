...
const columnDigits: Record<string, number> = {
  ...
  floor_rate_annual: 4,
  score_floor: 4,
  score_floor_excess_annual: 4,
  score_alpha: 4,
  score_target_annual: 4,
  score_edge_raw_annual: 4,
  total_score: 4,
  p_hit_tp: 3,
  p_hit_sl: 3,
  sigma_h: 4,
  ...
  sl_net: 4,
  signal_score: 4,
  score_exec_probability: 4,
  score_earn_probability: 4,
  score_gate_exec_threshold: 4,
  score_gate_earn_threshold: 4,
  signal_score_norm: 3,
  avg_trade_return_annual_recent: 2,
  avg_trade_return_annual_operational_recent: 2,
  score: 4,
  turnover: 2,
  sharpe: 2,
  cost_round_trip: 2,
